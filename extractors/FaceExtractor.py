...
class Detector(object):
    ...
    def run(self):
        ...
        with mp_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5, max_num_faces=1,
                                   refine_landmarks=True) as pose:
                ...
                if results.multi_face_landmarks:
                    for face_landmarks in results.multi_face_landmarks:
                        ...
                        mp_drawing.draw_landmarks(
                            ...
                            landmark_drawing_spec=None)
                # if results.multi_face_landmarks:
                # self.construct_state(results.multi_face_landmarks.landmark)
...
if __name__ == '__main__':
    cap = cv2.VideoCapture('../../data/helath_data.mp4')
    det = Detector(cap, '../../data/out.json', is_file=True)
    det.run()
